...
$(document).ready(function () {
   ...
   // setInterval(
   //    function () {
   //       $.post("https://chick-patrol.test/index.php/Admin_api/get_all_orders_total", {}, function (response) {
   //          for (let i = 0; i < response.length; i++) {
   //             let status = response[i]['status']
   //             console.log(`.${status.replace(' ', '-')}-notification-badge`)
   //             if (response[i]['total'] > 0)
   //                $(`.${status.replace(' ', '-')}-notification-badge`).html(`
   ...
   //             else {
   //                console.log('haha')
   //                $(`.for-approval-notification-badge, .preparing-notification-badge, .on-delivery-notification-badge`).html('')
   //             }
   //          }
   //       })
   //    }, 2000
